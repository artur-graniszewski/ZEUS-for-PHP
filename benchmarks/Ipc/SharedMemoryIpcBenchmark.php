...
class SharedMemoryIpcBenchmark extends AthleticEvent
{
    ...
    public function __construct()
    {
        ...
        $this->ipcAdapter = $this->serviceManager->build(IpcAdapterInterface::class, ['logger_adapter' => $logger, 'ipc_adapter' => SharedMemoryAdapter::class, 'service_name' => 'zeus-test-' . md5(microtime(true))]);
